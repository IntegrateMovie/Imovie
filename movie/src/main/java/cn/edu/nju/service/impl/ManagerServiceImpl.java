...
public class ManagerServiceImpl implements ManagerService {
    ...
    private final HotelBillRepository hotelBillRepository;
    ...
    public ManagerServiceImpl(OpenApplicationRepository openApplicationRepository, ModifyApplicationRepository modifyApplicationRepository, HotelRepository hotelRepository, 
    		...
    		MemberRepository memberRepository, MemberService memberService, LiveMesRepository liveMesRepository,HotelBillRepository hotelBillRepository) {
        ...
        this.hotelBillRepository = hotelBillRepository;
    }
    ...
    @Override
	public List<HotelmanagementEntity> getAllHotelBill(int page) {
    	List<HotelmanagementEntity> result = new ArrayList<>(SystemDefault.LIST_DEFAULT_SIZE);
    	Page<HotelmanagementEntity> pages;
    	if(page >= 0){
    		 pages = hotelBillRepository.findAll(new PageRequest(page , SystemDefault.SIZE_PER_PAGE));
    		 pages.forEach(result::add);
    	}else{
    		hotelBillRepository.findAll().forEach(result::add);
    	}
